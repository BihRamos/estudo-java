/* -O método .equals("1") compara strings.

-O while é uma estrutura de repetição usada para executar um 
bloco de código enquanto uma condição for verdadeira.

- System.exit(0); serve para finalizar o programa.
*/
package banco2;
 import javax.swing.*;
public class Banco2 {
    ...
    public static void main(String[] args) {
      ...
      nome = JOptionPane.showInputDialog("Digite seu nome:");
        ...
        while (true) {
           ...
           if (opcao.equals("1"))//compararstring// 
           {
